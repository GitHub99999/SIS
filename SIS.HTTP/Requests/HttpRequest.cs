    ...
    public class HttpRequest : IHttpRequest
    {
        ...
        private void ParseCookies()
        {
            if (this.Headers.ContainsHeader(HttpHeader.Cookie))
            {
                ...
                foreach (var unprasedCookie in unparsedCookies)
                {
                    string[] cookieKeyValuePair = unprasedCookie.Split(new[] {'='}, 2);

                    HttpCookie httpCookie = new HttpCookie(cookieKeyValuePair[0], cookieKeyValuePair[1]);
